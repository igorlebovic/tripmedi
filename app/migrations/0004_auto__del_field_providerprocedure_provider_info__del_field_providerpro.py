...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProviderProcedure.provider_info'
        db.delete_column('app_providerprocedure', 'provider_info')

        # Deleting field 'ProviderProcedure.flight_time'
        db.delete_column('app_providerprocedure', 'flight_time')

        # Adding field 'Provider.flight_time'
        db.add_column('app_provider', 'flight_time', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Provider.provider_info'
        db.add_column('app_provider', 'provider_info', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ProviderProcedure.provider_info'
        db.add_column('app_providerprocedure', 'provider_info', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)
        ...
        # Deleting field 'Provider.flight_time'
        db.delete_column('app_provider', 'flight_time')

        # Deleting field 'Provider.provider_info'
        db.delete_column('app_provider', 'provider_info')
    ...
    models = {
        ...
        'app.provider': {
            ...
            'provider_info': ('django.db.models.fields.TextField', [], {'null': 'True'}),
